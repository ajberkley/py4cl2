    ...
    (if *print-python-object*
        (progn
          ...
          (pprint-logical-block (s nil :per-line-prefix "  ")
            ;; This is cute, but if we try to print an object while
            ;; interacting with python this can cause a problem...
            (format *standard-output* "Trying to print python object...~%")
